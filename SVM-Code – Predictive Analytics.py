# -*- coding: utf-8 -*-
"""
Created on Mon Aug 21 13:43:12 2023
...
b_model = sklearn.svm.SVR(kernel="linear") #linear, rbf, poly

b_model.fit(x_train,y_train)

predicted_y_values = b_model.predict(x_test)

APE = abs(predicted_y_values-y_test)/y_test *100
...
#rationalization
b_model = sklearn.svm.SVR(kernel="rbf") #linear, rbf, poly
...
b_model = sklearn.svm.SVR(kernel="poly") #linear, rbf, poly
